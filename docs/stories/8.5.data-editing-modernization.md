...
- [x] Task 1: Create editor helper module with data_editor configurations (AC: 1, 2, 5, 6)
  - [x] Create `src/ui/helpers/editor.py` with column configurations
  - [x] Implement associate editor configuration with typed columns
  - [x] Implement bookmaker editor configuration with validation
  - [x] Add reusable editor wrapper functions
  - [x] Add validation helpers for share percentages and currency codes

- [x] Task 2: Implement master-detail associates page structure (AC: 3)
  - [x] Create top-level associates data editor with selection capability
  - [x] Create filtered bookmakers data editor below associates
  - [x] Implement associate selection â†’ bookmaker filtering logic
  - [x] Add session state management for selected associate
  - [x] Test master-detail interaction and data flow

- [x] Task 3: Replace associate CRUD with data_editor (AC: 1, 5, 6, 7)
  - [x] Update `src/ui/pages/7_admin_associates.py` associates section
  - [x] Replace current forms with `st.data_editor` using editor helpers
  - [x] Configure read-only ID columns and required field validation
  - [x] Implement add/remove row functionality where appropriate
  - [x] Add validation for alias uniqueness and currency codes
  - [x] Test associate CRUD operations through data_editor

- [x] Task 4: Replace bookmaker CRUD with data_editor (AC: 2, 5, 6, 7)
  - [x] Update bookmakers section to use `st.data_editor`
  - [x] Configure typed selects for parsing profiles and status
  - [x] Implement bookmaker name validation and associate filtering
  - [x] Add parsing profile JSON validation in editor
  - [x] Test bookmaker CRUD operations through data_editor

- [x] Task 5: Implement bulk associate selection and deactivation (AC: 4)
  - [x] Add selection column to associates data_editor
  - [x] Implement bulk deactivation functionality
  - [x] Add confirmation dialog for bulk operations
  - [x] Test bulk selection and deactivation workflow
  - [x] Add proper error handling and rollback capabilities

- [x] Task 6: Add comprehensive validation and error handling (AC: 7)
  - [x] Implement share percentage validation (0-100% with decimal precision)
  - [x] Add currency code validation against supported currencies
  - [x] Implement alias uniqueness checking in real-time
  - [x] Add JSON schema validation for parsing profiles
  - [x] Test all validation scenarios and error messages
...
### Agent Model Used
- GPT-5 Codex (BMAD Dev)

### Debug Log References
- .ai/debug-log.md (2025-11-07 streamlit editor rollout)

### Completion Notes List
- Introduced `src/ui/helpers/editor.py` with typed column configs, validation helpers, and selection utilities powering the new Streamlit editors.
- Reworked `src/ui/pages/7_admin_associates.py` to render fragment-backed data editors, bulk deactivate flow, and legacy fallback routing.
- Added targeted unit/integration coverage for editor helpers plus refreshed associate CRUD integration tests.
